...
exports.rules = [
    createRule( // map View Container
        ...
        function (container, model) {
            ...
            var custom = model.getCustomTemplate(container) || {};
            obj['C-' + id] = {isFolder: true, name: 'c-' + id, children: ['C-' + id + '-VM', 'C-' + id + '-V']};
            obj['C-' + id + '-VM'] = {name: 'index.js', content: (custom.js || require('./templates/nonxor-vm.js.ejs'))({id: id, children: children})};
            obj['C-' + id + '-V'] = {name: 'index.html', content: (custom.html || require('./templates/nonxor-v.html.ejs'))({children: children, events: events})};
            return obj;
        }
    ),
    createRule( // map XOR View Container
        ...
        function (container, model) {
            ...
            var custom = model.getCustomTemplate(container) || {};
            obj['C-' + id] = {isFolder: true, name: 'c-' + id, children: ['C-' + id + '-VM', 'C-' + id + '-V']};
            obj['C-' + id + '-VM'] = {name: 'index.js', content: (custom.js || require('./templates/xor-vm.js.ejs'))({id: id, defaultChild: defaultChild, landmarks: landmarks})};
            obj['C-' + id + '-V'] = {name: 'index.html', content: (custom.html || require('./templates/xor-v.html.ejs'))({children: children, landmarks: landmarks, events: events})};
            return obj;
        }
    )
];
