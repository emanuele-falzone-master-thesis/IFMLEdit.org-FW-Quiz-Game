...
exports.rules = [
    ...
    createRule( // map element to action
        ...
        function (flow, model) {
            ...
            var custom = model.getCustomTemplate(flow) || {};    
            obj['E-' + id] = {name: id + '.js', content: (custom.js || require('./templates/navigation-to-action.js.ejs'))({id: id, containerId: containerId, target: target, bindings: bindings})};
            return obj;
        }
    )
];
