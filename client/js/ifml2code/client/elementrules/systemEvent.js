...
exports.rules = [
    createRule( // map System Event
        ...
        function (systemEvent, model) {
            ...
            var custom = model.getCustomTemplate(systemEvent) || {};
            obj['C-' + id] = {isFolder: true, name: 'c-' + id, children: ['C-' + id + '-VM', 'C-' + id + '-V']};
            obj['C-' + id + '-VM'] = {name: 'index.js', content: (custom.js || require('./templates/system-event-vm.js.ejs'))({id: id})};
            obj['C-' + id + '-V'] = {name: 'index.html', content: (custom.html || require('./templates/system-event-v.html.ejs'))({id: id, name: name})};
            return obj;
        }
    )
];
