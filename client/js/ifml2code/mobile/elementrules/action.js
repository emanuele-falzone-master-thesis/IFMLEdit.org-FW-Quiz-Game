...
exports.rules = [
    createRule( // map action
        ...
        function (action, model) {
            ...
            var custom = model.getCustomTemplate(action) || {};
            obj['A-' + id] = {name: id + '.js', content: (custom.js || require('./templates/action.js.ejs'))({id: id, name: name, parameters: parameters, results: results, events: events})};
            return obj;
        }
    )
];
