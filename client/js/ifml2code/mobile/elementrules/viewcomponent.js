...
exports.rules = [
    createRule( // map list
        ...
        function (component, model) {
            ...
            var custom = model.getCustomTemplate(component) || {};
            obj['C-' + id] = {isFolder: true, name: 'c-' + id, children: ['C-' + id + '-VM', 'C-' + id + '-V']};
            obj['C-' + id + '-VM'] = {name: 'index.js', content: (custom.js || require('./templates/list-vm.js.ejs'))({id: id, selection: selection, collection: collection, filters: filters, fields: fields, incomings: incomings})};
            obj['C-' + id + '-V'] = {name: 'index.html', content: (custom.html || require('./templates/list-v.html.ejs'))({name: name, events: events, fields: fields, showSelection: showSelection})};
            return obj;
        }
    ),
    createRule( // map details
        ...
        function (component, model) {
            ...
            var custom = model.getCustomTemplate(component) || {};
            obj['C-' + id] = {isFolder: true, name: 'c-' + id, children: ['C-' + id + '-VM', 'C-' + id + '-V']};
            obj['C-' + id + '-VM'] = {name: 'index.js', content: (custom.js || require('./templates/details-vm.js.ejs'))({id: id, collection: collection, fields: fields, incomings: incomings})};
            obj['C-' + id + '-V'] = {name: 'index.html', content: (custom.html || require('./templates/details-v.html.ejs'))({name: name, events: events, fields: fields})};
            return obj;
        }
    ),
    createRule( // map form
        ...
        function (component, model) {
            ...
            var custom = model.getCustomTemplate(component) || {};
            obj['C-' + id] = {isFolder: true, name: 'c-' + id, children: ['C-' + id + '-VM', 'C-' + id + '-V']};
            obj['C-' + id + '-VM'] = {name: 'index.js', content: (custom.js || require('./templates/form-vm.js.ejs'))({id: id, fields: fields, incomings: incomings})};
            obj['C-' + id + '-V'] = {name: 'index.html', content: (custom.html || require('./templates/form-v.html.ejs'))({id: id, name: name, events: events, fields: fields})};
            return obj;
        }
    )
];
