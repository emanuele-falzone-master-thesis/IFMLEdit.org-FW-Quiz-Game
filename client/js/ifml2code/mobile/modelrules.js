        ...
        function (model) {
            var controls = _.chain(model.elements)
                ...
                collections = _.chain(model.elements)
                    ...
                    .uniq()
                    .value();
                var main_application = model.getCustomTemplateById('main-application') || {};
                var config = model.getCustomTemplateById('config') || {};
                var gulpfile = model.getCustomTemplateById('gulpfile') || {};
                var index = model.getCustomTemplateById('index') || {};
                var pack = model.getCustomTemplateById('package') || {};
            return {
                ...
                'package': {name: 'package.json', content:(pack.json || require('./templates/package.json.ejs'))()},
                'config': {name: 'config.xml', content: (config.xml || require('./templates/config.xml.ejs'))()},
                'gitignore': {name: '.gitignore', content: require('./templates/gitignore.ejs')()},
                'gulp': {name: 'gulpfile.js', content: (gulpfile.js || require('./templates/gulpfile.js.ejs'))()},
                'src': {isFolder: true, name: 'src', children: ['js', 'index']},
                'index': {name: 'index.html', content: (index.html || require('./templates/index.html.ejs'))()},
                'js': {isFolder: true, name: 'js', children: ['js-index', 'controls', 'navigations', 'actions', 'repositories']},
                'js-index': {name: 'index.js', content: (index.js || require('./templates/index.js.ejs'))()},
                ...
                'main-application-VM': {name: 'index.js', content: (main_application.js || require('./templates/main-application-vm.js.ejs'))({defaultChild: defaultChild})},
                'main-application-V': {name: 'index.html', content: (main_application.html || require('./templates/main-application-v.html.ejs'))({children: children, landmarks: landmarks})},
    ...
    createRule(
        ...
        function (model) {
            ...
            _.each(collections, function (c) {
                var custom = model.getCustomTemplateById(c.name) || {};
                obj[c.name + '-Repository'] = {isFolder: true, name: c.name, children: [c.name + '-Repository-Index', c.name + '-Repository-Default']};
                obj[c.name + '-Repository-Index'] = {name: 'index.js', content: (custom.js || require('./templates/repository.js.ejs'))({name: c.name})};
                obj[c.name + '-Repository-Default'] = {name: 'default.json', content: (custom.json || require('./templates/default.json.ejs'))({fields: c.fields})};
            });
            return obj;
        }
    )
